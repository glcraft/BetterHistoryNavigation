<#
    ...
    .DESCRIPTION
        The function BetterHistoryNavigation() overrides keys handler using 
        PSReadLine to perform lazy research over your hiustory command.
        More information in the BetterHistoryNavigation() function help.
    .LINK
...
#>
function BetterHistoryNavigation {    
    $funcName={
